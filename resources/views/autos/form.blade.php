        ...
        $('#formulario').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function( msg ) {
                    ...
                    $("#ocultar1").hide();
                    $("#ocultar2").hide();
                    $("#ajaxResponse").append("<br><div class=\"alert alert-success col-xs-11\" role=\"alert\"><button class=\"close\" data-dismiss=\"alert\">×</button>"+msg.msg+"</div>");
                    $("#ajaxResponse").append("<div class=\"\"><h4>Link público para compartir: </h4><div class=\"input-group\"><input type=\"text\" id=\"ruta\" class=\"form-control\" value=\""+msg.token+"\" readonly><span class=\"input-group-addon btn btn-primary alert-info\" id=\"visible-button\" title=\"Copiar Link\"><i class=\"glyphicon glyphicon-copy\"  onclick=\"copyToClipboard('#ruta')\" aria-hidden=\"true\"></i></span></div><a class=\"btn btn-primary btn-lg btn-block\" href=\""+msg.volver+"\">Crear otro auto </a></div>");
